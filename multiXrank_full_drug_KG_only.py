...
multixrank_obj = multixrank.Multixrank(config="config_full_drug_KG_only.yml", wdir="/cbio/users/francis_agamah/SOFT/multiXrank")
...
##RANKING FOR DRUG
#ranking nodes
multixrank_obj.write_ranking(ranking_df, path="Output_Files/results_drug_KG_only/")


multixrank_obj.to_sif(ranking_df, path="Output_Files/results_drug_KG_only/multi_layer_drug_KG_only.sif", top=3)
