...
multixrank_obj = multixrank.Multixrank(config="config_full_drug_KG_and_DSOG_severe_validation.yml", wdir=workdir)
...
##RANKING FOR DRUG
#ranking nodes
multixrank_obj.write_ranking(ranking_df, path=str(output_dir + "results_drug_KG_and_DSOG/severe"))


multixrank_obj.to_sif(ranking_df, path=str(output_dir + "results_drug_KG_and_DSOG/severe/multi_layer_drug_KG_and_DSOG_severe.sif", top=3))
