...
multixrank_obj = multixrank.Multixrank(config="config_full_drug_KG_and_DSOG_moderate_validation.yml", wdir=workdir)
...
##RANKING FOR DRUG
#ranking nodes
multixrank_obj.write_ranking(ranking_df, path=str(output_dir + "results_drug_KG_and_DSOG/moderate"))


multixrank_obj.to_sif(ranking_df, path= str(output_dir + "results_drug_KG_and_DSOG/moderate/multi_layer_drug_KG_and_DSOG_moderate.sif", top=3))
