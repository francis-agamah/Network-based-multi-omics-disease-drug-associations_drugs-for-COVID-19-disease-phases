...
multixrank_obj = multixrank.Multixrank(config="config_full_drug_KG_and_DSOG_mild_KO.yml", wdir=workdir)
...
##RANKING FOR DRUG
#ranking nodes
multixrank_obj.write_ranking(ranking_df, path=str(output_dir + "esults_drug_KG_and_DSOG/mild"))
